...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/03/06 10:22:12 by cledant           #+#    #+#             */
/*   Updated: 2016/03/06 10:37:33 by cledant          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "RTv1.h"

static void		ft_init_color(t_cone *obj, int (*ambiant_color)[4],
...
static void		ft_do_diff(t_cone *obj, int (*diff_color)[4],
					double angle)
{
...
static void		ft_do_spec(t_cone *obj, int (*spec_color)[4],
					double spec_angle)
{
					...
					double int_coord[3], double cam_vector[3])
{
	...
	ft_calc_norm_vec_cone(obj, &norm_vec, int_coord, light);
